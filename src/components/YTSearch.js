...
const YTSearch = () => {
  ...
  return (
    <div className=' pt-5'>
      <form action="">
        <div className='flex w-40 sm:w-auto items-center justify-center '>
          <input 
      ...
      {(isSuggetionsVisible && suggetions.length !== 0) && <div className=' fixed rounded-lg bg-[#2b2b2b] p-2 z-[100] w-96'>
