        ...
        <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
          ...
          <div className="text-gray-700 flex flex-col w-full">
            ...
            <div className="flex pl-4 justify-start mt-2">
              ...
              <a className=" flex items-center text-gray-300 hover:text-white mr-6 no-underline" href="https://github.com/Arham689/">
              ...
              <a className=" flex items-center text-gray-300 hover:text-white no-underline" href="https://www.linkedin.com/in/abdul-arham-504b3220a/">
                <svg viewBox="0 0 24 24" className="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg">
